...
String apiKey = "N5VPF11JYV15Y5AU"; // write your "Write API key"
const char* ssid = "Airtel_Youngovator"; // write your "wifi name"
const char* password = "Teamyoungovator23"; // write your "wifi password"
